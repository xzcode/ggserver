...
import xzcode.ggserver.core.proxy.handler.web.WebSocketInboundFrameHandler;
import xzcode.ggserver.core.proxy.handler.web.WebSocketOutboundFrameHandler;
...
public class TcpSocketSelectHandler extends ByteToMessageDecoder {
	...
	public TcpSocketSelectHandler(GGProxyConfig config) {
		super();
		this.config = config;
	}
