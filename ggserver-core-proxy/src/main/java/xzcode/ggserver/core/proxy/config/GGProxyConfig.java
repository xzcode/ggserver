...
import xzcode.ggserver.core.proxy.component.GGComponentManager;
import xzcode.ggserver.core.proxy.constant.GGServerTypeConstants;
import xzcode.ggserver.core.proxy.event.EventInvokerManager;
import xzcode.ggserver.core.proxy.executor.factory.EventLoopGroupThreadFactory;
import xzcode.ggserver.core.proxy.handler.serializer.ISerializer;
import xzcode.ggserver.core.proxy.handler.serializer.factory.SerializerFactory;
import xzcode.ggserver.core.proxy.message.filter.MessageFilterManager;
import xzcode.ggserver.core.proxy.message.receive.RequestMessageManager;
import xzcode.ggserver.core.proxy.message.send.SendMessageManager;
import xzcode.ggserver.core.proxy.session.GGUserSessonManager;
...
public class GGProxyConfig {
	...
	public GGProxyConfig(boolean client) {
		super();
		this.client = client;
		init();
	}
