package xzcode.ggserver.core.proxy.message.send;
...
import xzcode.ggserver.core.proxy.utils.json.GGServerJsonUtil;
...
public class SendMessageManager implements ISendMessageSupport{
	...
	public SendMessageManager(GGProxyConfig config) {
		super();
		this.config = config;
	}
