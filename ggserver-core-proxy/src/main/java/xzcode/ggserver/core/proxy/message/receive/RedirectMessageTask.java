...
public class RedirectMessageTask implements Runnable{
	...
	public RedirectMessageTask(String action, Object message, GGSession session, Object syncLock, GGProxyConfig config) {
	...
	public RedirectMessageTask(String action, Object message, GGSession session, GGProxyConfig config) {
		this.message = message;
		this.session = session;
		this.action = action;
		this.config = config;
