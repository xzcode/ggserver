package xzcode.ggserver.core.proxy.executor;

import java.util.concurrent.TimeUnit;

import io.netty.channel.nio.NioEventLoopGroup;
import io.netty.util.concurrent.ScheduledFuture;
import xzcode.ggserver.core.proxy.executor.future.GGTaskFuture;
import xzcode.ggserver.core.proxy.executor.task.GGTask;
