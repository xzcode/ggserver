package xzcode.ggserver.core.proxy.starter;
...
import xzcode.ggserver.core.proxy.handler.MixedSocketChannelInitializer;
 ...
 * 2018-12-20 10:17:44
 */
public class GGProxyServerStarter{
	
	private static final Logger logger = LoggerFactory.getLogger(GGProxyServerStarter.class);
	
	private GGProxyConfig config;
	
    public GGProxyServerStarter(GGProxyConfig config) {
    	this.config = config;
    }
    
    public GGProxyServerStarter run() {
     ...
     * 2017-07-27
     */
    public GGProxyServerStarter shutdown() {
