...
public class TcpDecodeHandler extends ByteToMessageDecoder {
	...
	public TcpDecodeHandler(GGProxyConfig config) {
		super();
		this.config = config;
	}
	...
	protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
		...
		*/
		...
		config.getTaskExecutor().submit(new RequestMessageTask(dataTag, data, ctx.channel().attr(GGProxyChannelAttributeKeys.SESSION).get(), config));
