package xzcode.ggserver.core.proxy.handler.idle;
...
public class IdleHandler extends ChannelInboundHandlerAdapter{
	...
	public IdleHandler(GGProxyConfig config) {
		this.config = config;
		init();
	}
	...
	public void userEventTriggered(ChannelHandlerContext ctx, Object evt) throws Exception {
		...
		if (evt instanceof IdleStateEvent) {
			...
			GGSession session = ctx.channel().attr(GGProxyChannelAttributeKeys.SESSION).get();
