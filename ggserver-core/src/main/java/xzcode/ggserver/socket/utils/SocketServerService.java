package xzcode.ggserver.socket.utils;

import java.lang.reflect.ParameterizedType;
import java.lang.reflect.Type;
import java.lang.reflect.TypeVariable;

import xzcode.ggserver.socket.channel.ChannelGroupsManager;
import xzcode.ggserver.socket.config.GGSocketConfig;
import xzcode.ggserver.socket.event.EventRunnableInvoker;
import xzcode.ggserver.socket.event.IEventInvoker;
import xzcode.ggserver.socket.message.MessageInvokerManager;
import xzcode.ggserver.socket.message.SocketOnMessage;
import xzcode.ggserver.socket.message.invoker.OnMessagerInvoker;
import xzcode.ggserver.socket.sender.SendModel;
import xzcode.ggserver.socket.session.SocketSessionUtil;
import xzcode.ggserver.socket.session.UserSessonManager;
...
public class SocketServerService {
	...
	private GGSocketConfig serverConfig;
	
	


	public SocketServerService(GGSocketConfig serverConfig) {
		super();
